				...
				<div className="relative group">
					<input
						...
						className={classNames(
							...
							'relative block w-full px-10 py-2 text-black transition-all duration-300 ease-in-out border-2 rounded-xl bg-red-light bg-opacity-10 focus-within:bg-white focus-within:shadow-sm hover:bg-white disabled:bg-gray-light disabled:bg-opacity-50 disabled:placeholder-transparent outline-none focus:ring-4 focus:ring-red-light'
						)}
					/>
